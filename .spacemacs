...
values."
  ...
  (setq-default
   ...
   ;; when the current branch is not `develop'. Note that chec@feror
   ...
   dotspacemacs-default-font '("source"
                               :size 14
                               :weight normal
                               :width normal
                               :powerline-scale 1)
